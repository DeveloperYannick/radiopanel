...
<main class="container">
    ...
    <div class="content-body">
			...
			<tbody>
			<?php
$resultado = $link->query("SELECT * FROM shout ORDER BY id DESC limit 10");
...
?>
				<tr>
							  ...
							  <td><?php echo "$row[shout]"; ?></td>
							  <td><a href="/panel/delete/shout.php?id=<?php echo "$row[id]"; ?>"><button type="button" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></button></a></td>
				</tr>
				<?php
			}
			?>
